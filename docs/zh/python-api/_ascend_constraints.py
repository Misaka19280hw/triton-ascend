...
CONSTRAINTS = {
    ...
    "triton.language.extra.cann.extension.custom": {
        "replace_docstring": [
            ...
            "",
            "The runnable example below covers an ordinary CustomOp; it does not exercise the CustomMacro synchronization configuration.",
            "",
            "Before running, obtain the Python example and its complete ``custom_op/`` companion directory from the repository.",
            "Keep ``custom_op/`` beside the Python file. The example selects the bundled bitcode for the active device",
            "and does not invoke ``ccec`` during the test; the device source includes commands for rebuilding the bitcode.",
            "",
            "Download :download:`Python example </python-api/_examples/triton.language.extra.cann.extension.custom.py>`,",
            ":download:`device source </python-api/_examples/custom_op/custom_add.cpp>`,",
            ":download:`A2/A3 bitcode </python-api/_examples/custom_op/custom_add_a3.bc>`, and",
            ":download:`A5 bitcode </python-api/_examples/custom_op/custom_add_a5.bc>`.",
        ],
        "constraints": [
